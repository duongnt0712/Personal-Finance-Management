...
public class StudentProfilesReport {
  ...
  /**input: student year of birth */
  @DAttr(name = "yob", type = Type.String, length = 30)
  private String yob;
  ...
  @DAttr(name="students",type=Type.Collection,optional=false, mutable=false,
      ...
      ,attributes={Student.A_id, Student.A_name, Student.A_dob, Student.A_address, 
          Student.A_email, Student.A_rptStudentByName, Student.A_rptStudentProfile}
      ), derivedFrom={"name, yob"})
  @DAssoc(ascName="student-profiles-report-has-students",role="report",
  ...
  public StudentProfilesReport(@AttrRef("name") String name) throws NotPossibleException, DataSourceException {
    this.id=++idCounter;
  ...
  @DOpt(type=DOpt.Type.ObjectFormConstructor)
  public StudentProfilesReport(@AttrRef("name") String name, @AttrRef("yob") String yob) throws NotPossibleException, DataSourceException {
    this.id=++idCounter;
...
//    boolean doReportQuery = (name != null && !name.equals(this.name));
	...
	public void setYob(String yob) throws NotPossibleException, DataSourceException {
		this.yob = yob;
		//doReportQuery();
	}
...
/**
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    StudentProfilesReport other = (StudentProfilesReport) obj;
    if (id != other.id)
      return false;
    return true;
  }
  ...
  public String toString() {
    return "StudentsByNameReport (" + id + ", " + name + ", " + yob + ")";
  }
