...
public class ExpenseAndIncomeByMonthReport {
	...
	@DAttr(name = R_dailyIncome, type = Type.Collection, optional = false, mutable = false, serialisable = false, filter = @Select(clazz = DailyIncome.class), derivedFrom = {"month"})
	...
	public ExpenseAndIncomeByMonthReport(@AttrRef("month") String month, @AttrRef("year") String year) throws NotPossibleException, DataSourceException {
		this.id = ++idCounter;
		this.month = month;	
		this.year = year;
